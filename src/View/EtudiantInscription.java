...
public class EtudiantInscription extends JFrame {

    public EtudiantInscription() {
        setTitle("Etudiant Inscription");
        setSize(400, 300);
        ...
        signUpButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // Call the registerUser method from DatabaseHandler for Etudiant
