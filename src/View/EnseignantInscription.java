...
public class EnseignantInscription extends JFrame {

    public EnseignantInscription() {
        setTitle("Enseignant Inscription");
        setSize(400, 300);
        ...
        signUpButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // Call the registerUser method from DatabaseHandler for Enseignant
